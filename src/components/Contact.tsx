      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-block bg-secondary-100 rounded-full px-4 py-1 mb-4">
            <span className="text-secondary-600 font-medium text-sm">Get In Touch</span>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-1/2 bg-gray-50 rounded-3xl p-8 shadow-lg">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                <p className="text-gray-600 mb-1">
                  Main Office: +91 9573866956
                </p>
                <p className="text-gray-600">
                  Admissions: +91 7013469561
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                <p className="text-gray-600 mb-1">
                  info@alanischool.edu
                </p>
                <p className="text-gray-600">
                  admissions@alanischool.edu
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                <h3 className="text-lg font-bold text-gray-800 mb-2">School Hours</h3>
                <p className="text-gray-600 mb-1">
          ...
          <div className="lg:w-1/2 bg-white rounded-3xl shadow-lg overflow-hidden">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d242.0952499728905!2d78.41328054863019!3d17.373681000000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb97a09ae7eeb7%3A0x90a135eb1bb42dab!2sBapuji%20High%20School!5e0!3m2!1sen!2sin!4v1709711843411!5m2!1sen!2sin"
